# still DE but compare between POS and NEG on each day for each cell type; 
perform_DE_compareSarsStatus_onTypeDay <- function(allvirus) {
  # set variables
  whole.obj <- allvirus
...
# perform_DE_compareSars_onTypeDay(allvirus)